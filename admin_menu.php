            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="pages/browse_data.php"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">Cari Data</span></a></li>
                        <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="plus" class="feather-icon"></i><span
                                    class="hide-menu">Masukan Data</span></a>
                            <ul aria-expanded="true" class="collapse first-level base-level-line">
                                <li class="sidebar-item"> <a class="sidebar-link" href="pages/insert_rent_data.php"
                                        aria-expanded="false"><i data-feather="send" class="feather-icon"></i><span
                                            class="hide-menu">Rental
                                        </span></a>
                                </li>
                                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                        href="pages/insert_book_data.php" aria-expanded="false"><i data-feather="book"
                                            class="feather-icon"></i><span class="hide-menu">Buku</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                        href="pages/add_account_data.php" aria-expanded="false"><i data-feather="user"
                                            class="feather-icon"></i><span class="hide-menu">Akun Pengguna</span></a>
                                </li>
                                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                        href="pages/insert_genre_data.php" aria-expanded="false"><i
                                            class="icon-layers"></i><span class="hide-menu">Genre</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                        href="pages/insert_publisher_data.php" aria-expanded="false"><i
                                            class="icon-people"></i><span class="hide-menu">Penerbit</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                        href="pages/insert_author_data.php" aria-expanded="false"><i
                                            class="icon-emotsmile"></i><span class="hide-menu">Penulis</span></a></li>
                            </ul>
                        </li>
                        <li class="list-divider"></li>
                        <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="pages/logout.php"
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Selamat Datang Kembali
                            Sobatku!</h3>
                                    ...
                                    <div>
                                        <div class="d-inline-flex align-items-center">
                                            <h2 class="text-dark mb-1 font-weight-medium">
                                                <?php $db->count_rental_data(); ?></h2>
                                        </div>
                                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Buku Disewa
                                        </h6>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex d-lg-flex d-md-block align-items-center">
                                    <div>
                                        <div class="d-inline-flex align-items-center">
                                            <h2 class="text-dark mb-1 font-weight-medium">
                                                <?php $db->count_account_data(); ?></h2>
                                        </div>
                                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Akun Peminjam
                                        </h6>
                                    </div>
                                    <div class="ml-auto mt-md-3 mt-lg-0">
