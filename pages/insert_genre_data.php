                            ...
                            <form class="row g-3" action="simpan_data_jenis_buku.php" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kode_jenis_buku"
                                            name="kode_jenis_buku" maxlength="8" placeholder="Unique Genre ID" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nama_jenis_buku" class="form-label">Genre Name</label>
                                        <input type="text" class="form-control" id="nama_jenis_buku"
                                            name="nama_jenis_buku" placeholder="ex. Psychological" required>
                                    </div>
                                </div>
