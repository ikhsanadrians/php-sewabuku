                            ...
                            <form class="row g-3" action="simpan_peminjaman.php" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%" id="kode_buku"
                                            name="kode_buku">
                                            <option selected="selected">ex. Mindset: The New Psychology of Success
                                            </option>
                                            <?php
                          $no = 1;
                          ...
                          ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" id="kode_peminjam"
                                            name="kode_peminjam">
