        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="browse_data.php" class="text-muted">Browse</a>
                                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 px-0">
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-3" action="simpan_edit_data_peminjam.php" method="post"
                                enctype="multipart/form-data">
                                <div class="col-md-12 px-0">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="kode_peminjam" class="form-label">Username</label>
                                            <input type="text" class="form-control" id="kode_peminjam" maxlength="8"
                                                value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>" disabled>
