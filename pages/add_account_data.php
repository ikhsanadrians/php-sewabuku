        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 px-0">
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-3" action="simpan_data_peminjam.php" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kode_peminjam" name="kode_peminjam"
                                            maxlength="8" placeholder="ex. Abc12341" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_peminjam" name="nama_peminjam"
                                            placeholder="ex. David Beckham" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="jenis_kelamin">Gender</label>
                                        <select class="form-control select2" style="width: 100%" id="jenis_kelamin"
                                            name="jenis_kelamin">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                            placeholder="ex. College Student">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="alamat" name="alamat" rows="2"
                                            placeholder="Text Here..." style="resize: none;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
