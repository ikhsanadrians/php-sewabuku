                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark"><?= $data_peminjam[0]['kode_peminjam']; ?></span> <i
                                        data-feather="chevron-down" class="svg-icon"></i></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item" href="user_settings.php"><i data-feather="settings"
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="user_rent.php"
                                aria-expanded="false"><i data-feather="send" class="feather-icon"></i><span
                                    class="hide-menu">My Rent</span></a></li>
                        <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="book_data.php"
                                aria-expanded="false"><i data-feather="book" class="feather-icon"></i><span
                                    class="hide-menu">Books Data</span></a></li>
                        <li class="list-divider"></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3" action="simpan_edit_peminjam.php" method="post"
                              ...
                              ?>
                                                    <input type="file" class="custom-file-input" id="foto_peminjam"
                                                        name="foto_peminjam" accept="image/png, image/jpeg">
                                                    <input type="text" class="form-control"
                                                        name="foto_peminjam_unchanged"
                                                        value="<?php echo $data_peminjam[0]['foto']; ?>">
                                                    <label class="custom-file-label" for="foto_peminjam">No photo
                                                        yet.</label>
                                                    <?php
                              } else {
                              ?>
                                                    <div class="col-md-12 px-0">
                                                        <img src="<?php echo $data_peminjam[0]['foto']; ?>" alt=""
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        ...
                                                        <input type="hidden" class="form-control"
                                                            name="foto_peminjam_unchanged"
                                                            value="<?php echo $data_peminjam[0]['foto']; ?>">
                                                        <label class="custom-file-label" for="foto_peminjam">New
                                                            photo?</label>
                                                    </div>
                                                    <?php
                              }
                                        ...
                                        <div class="row px-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" id="kode_peminjam"
                                                        name="kode_peminjam" maxlength="8"
                                                        value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>">
                                                    <input type="text" class="form-control" id="kode_peminjam"
                                                        name="kode_peminjam" maxlength="8"
                                                        value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>"
                                                        disabled>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" id="password"
                                                        ...
                                                        value="<?php echo $data_peminjam[0]['password']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_peminjam"
                                                    name="nama_peminjam"
                                                    placeholder="<?php echo $data_peminjam[0]['nama_peminjam']; ?>"
                                                    value="<?php echo $data_peminjam[0]['nama_peminjam']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="row px-3">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="tanggal_lahir"
                                                        name="tanggal_lahir"
                                                        value="<?php echo $data_peminjam[0]['tanggal_lahir']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                                    placeholder="<?php echo $data_peminjam[0]['pekerjaan']; ?>"
                                                    value="<?php echo $data_peminjam[0]['pekerjaan']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="alamat" name="alamat" rows="2"
                                                    ...
                                                    style="resize: none;"><?php echo $data_peminjam[0]['alamat']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
