                            ...
                            <form class="row g-3" action="simpan_data_pengarang.php" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kode_pengarang"
                                            name="kode_pengarang" maxlength="8" placeholder="Unique Author ID" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nama_pengarang" class="form-label">Author Name</label>
                                        <input type="text" class="form-control" id="nama_pengarang"
                                            name="nama_pengarang" placeholder="ex. Mark Mason" required>
                                    </div>
                                </div>
