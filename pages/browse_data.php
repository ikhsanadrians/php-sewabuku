                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-justified nav-bordered mb-3">
                                    <li class="nav-item">
                                        <a href="#rental-tab" data-toggle="tab" aria-expanded="true"
                                    ...
                                    <li class="nav-item">
                                        <a href="#publisher-tab" data-toggle="tab" aria-expanded="false"
                                            class="nav-link">
                                            <i class="mdi mdi-settings-outline d-lg-none d-block mr-1"></i>
                                    ...
                                    <div class="tab-pane show active" id="rental-tab">
                                        <div class="table-responsive">
                                            <table id="zero_config"
                                                class="table table-striped table-bordered table-hover display no-wrap"
                                                style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                              ...
                              ?>
                                ...
                                ?>
                                    ...
                                    ?>
                                                            <img src="<?php echo $x['foto']; ?>" alt="" width="50"
                                                                height="50">
                                                            <?php
                                      }
                                    ?>
                                                        ...
                                                        <td><a
                                                                href="edit_account_data.php?id=<?php echo $x['kode_peminjam']; ?>">Edit</a><br><a
                                                                href="delete_account_data.php?id=<?php echo $x['kode_peminjam']; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                }
